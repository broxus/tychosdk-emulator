 ...
 * @return true in case of success, false in case of error
 */
bool transaction_emulator_set_libs(void *transaction_emulator, const char* libs_boc);
 ...
 */
void *tvm_emulator_create(const char *code_boc, const char *data_boc, int vm_log_verbosity);
 ...
 * @return true in case of success, false in case of error
 */
bool tvm_emulator_set_c7(void *tvm_emulator, const char *address, uint32_t unixtime, uint64_t balance, const char *rand_seed_hex, const char *config);
 ...
 */
void string_destroy(const char *string);
